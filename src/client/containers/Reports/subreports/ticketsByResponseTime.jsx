...
const ReportTicketsByResponseTime = () => {
  ...
  const onFormSubmit = e => {
    ...
    dispatch(
      generateReport({
        type: 'tickets_by_response_time',
        filename: `report_tickets_by_response_time__${moment(startDate).format('MMDDYYYY')}`,
        startDate,
        endDate,
      ...
      <TruCard
        ...
        header={
          <div style={{ padding: '10px 15px' }}>
            <h4 style={{ width: '100%', textAlign: 'left', fontSize: '14px', margin: 0 }}>
...
export default ReportTicketsByResponseTime
